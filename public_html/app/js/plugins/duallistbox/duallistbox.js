...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'Zonas comunes {0} ',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Filtrado(s)</span> {0} de {1}', // when not all of the options are visible due to the filter
